...
public class BuyImageViewActivity extends AppCompatActivity {
    private static final String TAG = "BuyImageViewActivity";
    String mImg1 = "";
    String mImg2 = "";
    TextView tvHeader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_image_view);
        try {
