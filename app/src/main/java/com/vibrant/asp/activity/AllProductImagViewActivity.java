...
public class AllProductImagViewActivity extends AppCompatActivity {
    private static final String TAG = "AllProductImagViewActiv";
    String mImg1 = "";
    String mImg2 = "";
    TextView tvHeader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_product_imag_view);
