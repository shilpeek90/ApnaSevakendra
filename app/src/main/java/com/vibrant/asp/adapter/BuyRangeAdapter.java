...
public class BuyRangeAdapter extends BaseAdapter {
    Context mContext;
    List<BuyRangeModel> rangeModelList;

    public BuyRangeAdapter(Context mContext, List<BuyRangeModel> rangeModels) {
    ...
    @Override
    public BuyRangeModel getItem(int position) {
